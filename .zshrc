...
# prompt
PROMPT='%{$fg_bold[green]%}%n%{$reset_color%} at %{$fg_bold[cyan]%}%c%{$reset_color%}$(git_prompt_info "(%s)")$ '
...
[[ -s /home/derek/.autojump/etc/profile.d/autojump.sh ]] && source /home/derek/.autojump/etc/profile.d/autojump.sh
